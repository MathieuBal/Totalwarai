...
def _learn_units(corpus: Corpus, wanted: str) -> int:
    ...
    from totalwar_ai.learning.elevation import study as hauteur
    ...
    # Se lit avant les degats : la hauteur se prend pendant l'approche, donc
    # avant que la question des degats se pose (ADR 0014).
    print(f"\n--- qui tenait la hauteur : {bataille.battle_id[:8]} ---\n")
    print(hauteur(iter_states(bataille.path)).render())
